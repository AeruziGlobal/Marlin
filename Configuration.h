...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter, @grbd, @AeruziGlobal" // Who made the changes.
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_SMOOTH_ROD_OFFSET 184   // (mm)
  ...
  #define DELTA_HEIGHT 272.00             // (mm) Get this value from G33 auto calibrate
